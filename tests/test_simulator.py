...
class SimulatorTest(unittest.TestCase):
    ...
    def test_simulator_returns_correct_results_given_non_random_spins(self):
        expected_durations = [52, 2, 2, 4, 24, 2, 6, 4, 98, 4, 250, 4, 12, 38, 6, 84, 2, 250, 12, 2, 150, 6, 8, 2, 8, 2, 4, 28, 2, 20, 6, 20, 6, 2, 26, 82, 2, 2, 4, 2, 2, 14, 38, 2, 14, 12, 4, 10, 2, 10]
        expected_maxima = [300, 50, 50, 100, 200, 50, 200, 100, 650, 150, 800, 100, 150, 300, 150, 500, 50, 1200, 200, 50, 800, 100, 150, 50, 250, 50, 100, 300, 50, 250, 150, 200, 100, 50, 250, 450, 50, 50, 100, 50, 50, 250, 400, 50, 200, 200, 150, 150, 50, 200]
